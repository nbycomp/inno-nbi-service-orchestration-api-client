...
from inno_nbi_api.api_response import ApiResponse, T as ApiResponseT
import inno_nbi_api.models
from inno_nbi_api import rest
from inno_nbi_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(inno_nbi_api.models, klass)
