...
class InfrastructureApi:
    ...
    def get_device_details(
        self,
        device_id: Annotated[StrictStr, Field(description="The unique identifier of the device to fetch details for.")],
        ...
        :param device_id: The unique identifier of the device to fetch details for. (required)
        :type device_id: str
    ...
    def _get_device_details_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/infrastructure/devices/{deviceId}',
    ...
    def get_site_details(
        self,
        site_id: Annotated[StrictStr, Field(description="The unique identifier of the site to fetch.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param site_id: The unique identifier of the site to fetch. (required)
        :type site_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_site_details_serialize(
            site_id=site_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_site_details_with_http_info(
        self,
        site_id: Annotated[StrictStr, Field(description="The unique identifier of the site to fetch.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_site_details_without_preload_content(
        self,
        site_id: Annotated[StrictStr, Field(description="The unique identifier of the site to fetch.")],
        _request_timeout: Union[
            None,
    ...
    def _get_site_details_serialize(
        self,
        site_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/infrastructure/sites/{siteId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
