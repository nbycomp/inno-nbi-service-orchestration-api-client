...
class DeviceMeta(BaseModel):
    ...
    DeviceMeta
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the device.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UNKNOWN', 'PASSIVE', 'CLOUDLET', 'CLOUDRESOURCE', 'PROVISION']):
            raise ValueError("must be one of enum values ('UNKNOWN', 'PASSIVE', 'CLOUDLET', 'CLOUDRESOURCE', 'PROVISION')")
        return value
